...
# Convert the training data to a DataFrame and save as CSV
pd.DataFrame(X_train_padded).to_csv('padded_training_data.csv', index=False)
...
model.add(LSTM(256, kernel_initializer=GlorotUniform(seed=42), recurrent_regularizer=l2(1e-5)))
